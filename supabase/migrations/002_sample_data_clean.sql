-- Clear existing sample data and re-insert fresh
...
DELETE FROM batches;
DELETE FROM courses;
DELETE FROM users WHERE email IN ('admin@llp-myanmar.com', 'waiyan@llp-myanmar.com', 'koaung@llp-myanmar.com');
...
-- ============================================
-- DONE! Fresh sample data inserted
-- ============================================
-- You now have:
...
SELECT 'SUCCESS: Sample data loaded!' as status,
