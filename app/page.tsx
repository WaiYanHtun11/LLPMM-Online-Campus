        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg mb-8 border border-blue-100">
              ...
              <span className="text-sm font-semibold text-gray-700">🎓 Now Enrolling - 5 Batches Available</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Link 
                href="/courses" 
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-10 py-5 rounded-full text-lg font-bold hover:shadow-2xl hover:scale-105 transition-all inline-flex items-center gap-2 group"
              >
                Browse All Courses
              ...
              <Link 
                href="/batches" 
                className="bg-white text-gray-800 px-10 py-5 rounded-full text-lg font-bold hover:shadow-xl border-2 border-gray-200 hover:border-blue-300 transition-all inline-flex items-center gap-2"
              >
            ...
            <div className="flex flex-wrap gap-8 justify-center items-center text-gray-600">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium">152+ Video Lessons</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-5xl font-extrabold mb-2">8.8K+</div>
              <div className="text-blue-100 text-sm uppercase tracking-wide">Students Taught</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-extrabold mb-2">152+</div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-3xl p-8 hover:shadow-2xl transition-all hover:-translate-y-2 border border-blue-200">
            ...
            {/* Feature 2 */}
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-3xl p-8 hover:shadow-2xl transition-all hover:-translate-y-2 border border-purple-200">
            ...
            {/* Feature 3 */}
            <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-3xl p-8 hover:shadow-2xl transition-all hover:-translate-y-2 border border-pink-200">
            ...
            {/* Feature 4 */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-3xl p-8 hover:shadow-2xl transition-all hover:-translate-y-2 border border-green-200">
            ...
            {/* Feature 5 */}
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-3xl p-8 hover:shadow-2xl transition-all hover:-translate-y-2 border border-orange-200">
            ...
            {/* Feature 6 */}
            <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-3xl p-8 hover:shadow-2xl transition-all hover:-translate-y-2 border border-indigo-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 overflow-hidden border border-gray-100 flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <h3 className="text-2xl font-bold mb-2 text-gray-900">Python Fundamentals</h3>
            ...
            <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 overflow-hidden border border-gray-100 flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <h3 className="text-2xl font-bold mb-2 text-gray-900">React & Next.js</h3>
