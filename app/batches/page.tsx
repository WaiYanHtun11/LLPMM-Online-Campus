      ...
      <div className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all hover:-translate-y-2 overflow-hidden flex flex-col">
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <div className="space-y-3 mb-4 flex-grow">
            {batch.schedule && (() => {
              const [days, times] = batch.schedule.split(' - ').map((s: string) => s.trim());
              return (
                <>
                  <div className="flex justify-between items-center text-sm text-gray-600">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-mono text-xs bg-gray-100 text-gray-700 px-2 py-0.5 rounded">days</span>
                    </div>
                  ...
                  {times && (
                    <div className="flex justify-between items-center text-sm text-gray-600">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-xs bg-gray-100 text-gray-700 px-2 py-0.5 rounded">time</span>
                      </div>
            ...
            <div className="flex justify-between items-center text-sm text-gray-600">
              ...
              <span className="text-gray-800">{batch.formattedStartDate}</span>
            </div>
            ...
            <div className="flex justify-between items-center text-sm text-gray-600">
              ...
              <span className="text-gray-800">{batch.instructor?.name || 'TBA'}</span>
            </div>
            ...
            <div className="flex justify-between items-center text-sm text-gray-600">
              ...
              <span className="text-gray-800">{batch.max_students} students</span>
            </div>
