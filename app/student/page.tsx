    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white mb-8 shadow-lg">
          ...
          <p className="text-blue-100">Continue your learning journey with your enrolled courses.</p>
        </div>

        {/* Quick Stats */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-r from-blue-200 via-cyan-200 to-blue-200 p-[1px] rounded-xl h-full">
            <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition h-full flex flex-col">
              <div className="flex items-center gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-r from-blue-200 via-cyan-200 to-blue-200 p-[1px] rounded-xl">
            <Link 
              ...
              className="bg-white rounded-xl p-6 shadow-sm hover:shadow-lg transition group block flex flex-col justify-between h-full"
            >
              <div>
                ...
                <p className="text-gray-600 text-sm mb-4">View your enrolled courses, schedules, and access class materials</p>
              </div>
              <span className="text-blue-600 text-sm font-semibold group-hover:translate-x-2 inline-block transition">View All Courses →</span>
            </Link>
          </div>
            ...
            >
              <div>
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <h3 className="text-lg font-bold text-gray-900">✅ Submit Attendance</h3>
                </div>
                <p className="text-gray-600 text-sm mb-4">Enter attendance codes provided by your instructor</p>
              </div>
              <span className="text-green-600 text-sm font-semibold group-hover:translate-x-2 inline-block transition">Submit Code →</span>
            </Link>
          </div>
          ...
          <div className="bg-gradient-to-r from-amber-200 via-orange-200 to-amber-200 p-[1px] rounded-xl">
            ...
            >
              <div>
                ...
                <p className="text-gray-600 text-sm mb-4">Submit assignments and view your grades</p>
              </div>
              <span className="text-orange-600 text-sm font-semibold group-hover:translate-x-2 inline-block transition">View Assignments →</span>
            </Link>
          </div>
            ...
            >
              <div>
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <h3 className="text-lg font-bold text-gray-900">💳 My Payments</h3>
                </div>
                <p className="text-gray-600 text-sm mb-4">View payment status, installment schedules, and history</p>
              </div>
              <span className="text-purple-600 text-sm font-semibold group-hover:translate-x-2 inline-block transition">View Payments →</span>
            </Link>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-200 via-pink-200 to-purple-200 p-[1px] rounded-xl">
          <div className="bg-white rounded-xl shadow-sm">
            <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-pink-50 rounded-t-xl flex items-center justify-between">
          ...
          {enrolledBatches.length === 0 ? (
            <div className="px-6 py-12 text-center text-gray-500">
              ...
              <p className="text-lg font-semibold mb-2">No courses enrolled yet</p>
              <p className="text-sm mb-4">Contact admin to enroll in a course</p>
              <Link 
                href="/courses"
              ...
              {enrolledBatches.slice(0, 5).map((batch) => (
                ...
                >
                  ...
                  {batch.course_image ? (
                    ...
                    <div className="w-20 h-20 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-lg flex items-center justify-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1">{batch.batch_name}</p>
